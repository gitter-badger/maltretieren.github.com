...
The path to follow is to query the [OSM Overpass Turbo API](http://overpass-turbo.eu/) with the wizard e.g.
 ...
 and exported it as GeoJSON file. Then the file is saved it to the ‘assets/geojson‘ folder of my Jekyll site and pushed to GitHub. This is very nice and simple!
